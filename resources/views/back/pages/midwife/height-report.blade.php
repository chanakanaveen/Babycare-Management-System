...
@section('pagetitle', 'Baby Height History')
@section('content')
...
<div class="col-md-12">
    <div class="pd-20 card-box mb-30">
        <div class="clearfix">
            <div class="pull-left">
                <h4 class="h4 text-blue">Baby Height History</h4>
            </div>
        </div>
...
$(document).ready(function(){
        ...
        $.ajax({
            ...
            success:function(response){
                console.log(response);
                 ...
                 const dates = records.map(record => record.record_date);
    ...
    function updateHeightChart(heights, dates) {
        ...
        heightChart = new Chart(ctx, {
            type: 'bar', // Line chart for height history
            data: {
                labels: dates, // X-axis labels (dates)
                datasets: [{
