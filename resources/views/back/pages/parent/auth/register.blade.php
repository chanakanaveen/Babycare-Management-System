...
@section('pagetitle', isset($pageTitle) ? $pageTitle : 'Create Parents Account')
@section('content')
<div class="login-box bg-white box-shadow border-radius-10">
    <div class="login-title">
      <h2 class="text-center text-primary">Create Parents Account</h2>
    </div>
    <form action="{{ route('parent.create') }}" method="POST">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="input-group mb-0">
            <a href="{{ route('parent.login') }}" class="btn btn-outline-primary btn-lg btn-block">Sign In</a>
          </div>
        </div>
      </div>
