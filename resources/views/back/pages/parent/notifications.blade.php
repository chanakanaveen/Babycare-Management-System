        ...
        <div class="card-box pd-20">
            ...
            <div class="d-flex justify-content-between align-items-center mb-20">
                ...
                @if($notifications->isNotEmpty())
                    <form action="{{ route('parent.notification.mark-all-read') }}" method="POST" id="mark-all-form">
                        @csrf
            ...
            @if($notifications->isEmpty())
                <div class="text-center py-60">
                    ...
                    <p class="text-muted font-14">You'll see vaccine schedules, appointment updates and other alerts here.</p>
                </div>
            @else
                        ...
                        <div class="notif-page-item {{ $isRead ? '' : 'notif-unread' }}" id="notif-item-{{ $notification->id }}">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-1">
                                    ...
                                    @if(!$isRead)
                                        <form action="{{ route('parent.notification.mark-read', $notification->id) }}" method="POST" class="d-inline">
                                            @csrf
