...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2025 at 05:17 PM
...
CREATE TABLE `admins` (
  ...
  `operational_jurisdiction` text DEFAULT NULL,
...
INSERT INTO `admins` (`id`, `name`, `username`, `email`, `password`, `picture`, `created_at`, `updated_at`, `designation`, `contact_information`, `registration_number`, `division_id`, `operational_jurisdiction`, `last_login`, `account_status`) VALUES
(1, 'Amila Disanayake', 'admin', 'admin@email.com', '$2y$10$VlZICfqzhMiulU0Szcd78.IIO8u5JJ6vQASnc1m1C5NBvWGLpNmBW', 'ADMIN_IMG_94111745782864680e885074f06.jpg', '2024-07-04 10:32:26', '2025-04-28 09:31:12', NULL, NULL, NULL, NULL, NULL, NULL, 'pending');
...
CREATE TABLE `baby` (
  ...
  `birth_hospital` varchar(255) DEFAULT NULL,
  ...
  `midwife_id` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `baby` (`baby_id`, `full_name`, `date_of_birth`, `gender`, `birth_weight`, `bmi`, `birth_hospital`, `blood_group`, `birth_complications`, `family_medical_history`, `initial_observations`, `midwife_id`, `parent_id`, `created_at`) VALUES
(1, 'Kasun jayakodi', '2025-01-15', 'male', 3.50, 8.72, 'City Hospital', 'O+', 'None', 'No known issues', 'Healthy baby', 1, 1, '2025-04-27 15:07:41'),
(2, 'Samitha Akalanka', '2025-02-20', 'female', 3.20, NULL, 'General Hospital', 'A+', 'Mild jaundice', 'Diabetes in maternal family', 'Requires monitoring for jaundice', 2, 2, '2025-04-27 15:07:41'),
(3, 'Divyanjalee Minvi', '2025-01-28', 'female', 3.20, NULL, 'Gampaha', 'A+', NULL, NULL, NULL, 2, 1, NULL),
(4, 'Sithum Perera', '2025-01-12', 'male', 3.20, 8.00, 'Castle Street Hospital', 'O+', 'None', 'No known issues', 'Healthy baby', 1, 1, '2025-04-28 11:58:04'),
(5, 'Dinuli Fernando', '2025-02-05', 'female', 2.90, 7.80, 'Sri Jayewardenepura Hospital', 'A+', 'Low birth weight', 'Maternal diabetes', 'Monitor weight gain', 2, 2, '2025-04-28 11:58:04'),
(6, 'Ashen De Silva', '2025-03-15', 'male', 3.40, 8.50, 'Colombo South Teaching Hospital', 'B+', 'None', 'Asthma in family', 'Monitor breathing', 3, 3, '2025-04-28 11:58:04'),
(7, 'Sanduni Wijesinghe', '2025-04-10', 'female', 3.10, 7.90, 'Negombo General Hospital', 'O-', 'Jaundice', 'No known issues', 'Monitor bilirubin levels', 2, 4, '2025-04-28 11:58:04'),
(8, 'Pasindu Jayawardena', '2025-01-22', 'male', 3.60, 9.00, 'Gampaha Hospital', 'AB+', 'None', 'Heart disease in paternal side', 'Routine checkups', 1, 5, '2025-04-28 11:58:04'),
(9, 'Nethmi Madushani', '2025-02-18', 'female', 3.00, 7.70, 'Kandy Teaching Hospital', 'B-', 'Mild breathing issues', 'Family asthma', 'Frequent monitoring needed', 2, 6, '2025-04-28 11:58:04'),
(10, 'Thimira Lakshan', '2025-03-28', 'male', 2.80, 7.20, 'Matara General Hospital', 'A+', 'Low birth weight', 'Premature history in family', 'Weight monitoring advised', 3, 7, '2025-04-28 11:58:04'),
(11, 'Dinithi Hansika', '2025-04-02', 'female', 3.30, 8.30, 'Badulla Provincial Hospital', 'O+', 'None', 'No known issues', 'Healthy baby', 2, 8, '2025-04-28 11:58:04'),
(12, 'Isuru Bandara', '2025-01-19', 'male', 3.70, 9.20, 'Anuradhapura Teaching Hospital', 'B+', 'Breathing difficulty', 'No known issues', 'Special care at NICU', 1, 9, '2025-04-28 11:58:04'),
(13, 'Vihansa Sewwandi', '2025-02-23', 'female', 2.70, 7.00, 'Kurunegala Hospital', 'AB-', 'Low weight', 'Maternal hypertension', 'Frequent weight checks', 2, 10, '2025-04-28 11:58:04'),
(14, 'Sajith Rajapaksha', '2025-03-05', 'male', 3.50, 8.70, 'Kalutara General Hospital', 'A-', 'None', 'No known issues', 'Healthy and active', 3, 11, '2025-04-28 11:58:04'),
(15, 'Pavithra Herath', '2025-04-14', 'female', 3.20, 8.00, 'Polonnaruwa Hospital', 'B+', 'Mild jaundice', 'No known issues', 'Phototherapy done', 1, 12, '2025-04-28 11:58:04'),
(16, 'Sandeepa Dilshan', '2025-02-07', 'male', 3.10, 7.60, 'Monaragala District Hospital', 'O+', 'None', 'Family history of allergies', 'Monitor for allergies', 2, 13, '2025-04-28 11:58:04'),
(17, 'Ishadi Samarakoon', '2025-03-22', 'female', 2.90, 7.30, 'Rathnapura Teaching Hospital', 'A+', 'None', 'No known issues', 'Healthy and breastfeeding well', 3, 14, '2025-04-28 11:58:04'),
(18, 'Thisal Peris', '2025-01-29', 'male', 3.60, 9.10, 'Galle Karapitiya Teaching Hospital', 'O-', 'None', 'Heart disease in father', 'Regular heart checks', 1, 15, '2025-04-28 11:58:04'),
(19, 'Sharanya Ketheeswaran', '2025-02-11', 'female', 3.40, 8.50, 'Jaffna Teaching Hospital', 'B+', 'Mild jaundice', 'No known issues', 'Monitoring complete', 2, 16, '2025-04-28 11:58:04'),
(20, 'Roshan Weerasekara', '2025-03-12', 'male', 3.30, 8.00, 'Hambantota General Hospital', 'AB+', 'None', 'Asthma on mother side', 'Watch for wheezing', 3, 17, '2025-04-28 11:58:04'),
(21, 'Shanika Jayasundara', '2025-04-01', 'female', 3.10, 7.80, 'Ampara Hospital', 'A+', 'Low birth weight', 'Premature births history', 'NICU care given', 2, 18, '2025-04-28 11:58:04'),
(22, 'Manuja Senaratne', '2025-01-18', 'male', 3.00, 7.50, 'Batticaloa Teaching Hospital', 'O+', 'Mild respiratory distress', 'Asthma in mother', 'Nebulized treatments needed', 1, 19, '2025-04-28 11:58:04'),
(23, 'Anuththara Pathirana', '2025-02-25', 'female', 3.20, 8.10, 'Trincomalee District Hospital', 'B-', 'None', 'No known issues', 'Routine baby care', 2, 20, '2025-04-28 11:58:04'),
(24, 'Nipuni Abisheka', '2025-01-29', 'female', 3.20, NULL, 'Wathupitiwala', 'A-', NULL, NULL, NULL, 5, 6, NULL);
...
INSERT INTO `clients` (`id`, `name`, `username`, `email`, `password`, `picture`, `phone`, `address`, `provinces`, `districts`, `cities`, `latitude`, `longitude`, `email_verified_at`, `verified`, `status`, `created_at`, `updated_at`, `emergency_contact`, `relationship_to_child`, `account_status`, `division_id`) VALUES
(1, 'Naveen', 'client', 'client@mail.com', '$2y$10$8cJRQaeXlBCysGE/Qg9mfetqhAV1bQpL5zmE70QUrNyS3O95mWvnm', 'CLIENT_IMG_3331172199512766a38f77d8bc8.jpg', '455464', 'Add new', '1', '5', '340', NULL, NULL, NULL, 1, 'Pending', '2024-07-24 14:20:03', '2024-07-29 15:36:52', NULL, NULL, NULL, 1),
(2, 'nc', NULL, 'nc@mail.com', '$2y$10$JxZLVrBij6bPbt.TjL1Jzuugi0Xvp2ytzO8a8ZbtbYfdGICq33FSi', NULL, '0767785941', 'asdasdfadfafafaadf', '1', '7', '513', NULL, NULL, NULL, 1, 'Pending', '2024-07-26 00:42:15', '2024-07-26 00:43:01', NULL, NULL, NULL, 3),
(3, 'Ravindu Dulanjana', NULL, 'ravidu@mail.com', '$2y$10$qZ6HDu6c16aXN6iGAnEYwOS.JaLWLoHCzqufmNT6YveHZzboAPAp.', 'CLIENT_IMG_3963172245815966aaa02f0f47d.jpg', '07123654871', 'Gall Road, Wellawaththa', '1', '5', '376', NULL, NULL, NULL, 1, 'Pending', '2024-07-31 15:00:00', '2024-07-31 15:09:51', NULL, NULL, NULL, 2),
(4, 'Sanduni Perera', 'sanduni123', 'sanduni@mail.com', '$2y$10$dummyhashedpassword', NULL, '0771234567', 'No.10, Galle Road, Colombo', '1', '5', '340', NULL, NULL, NULL, 1, 'Pending', '2025-04-28 12:01:33', '2025-04-28 12:01:33', '0777654321', 'Mother', 'active', 1),
(5, 'Kasun Fernando', 'kasunf', 'kasun@mail.com', '$2y$10$dummyhashedpassword', NULL, '0711122334', 'No.15, Main Street, Gampaha', '1', '7', '512', NULL, NULL, NULL, 1, 'Pending', '2025-04-28 12:01:33', '2025-04-28 12:01:33', '0717788996', 'Father', 'active', 2),
(6, 'Dilani Jayawardena', 'dilaniJ', 'dilani@mail.com', '$2y$10$dummyhashedpassword', NULL, '0755566778', 'No.55, Lake Drive, Kandy', '2', '8', '620', NULL, NULL, NULL, 1, 'Pending', '2025-04-28 12:01:33', '2025-04-28 12:01:33', '0752233445', 'Mother', 'active', 2),
(7, 'Tharindu Wickramasinghe', 'tharinduW', 'tharindu@mail.com', '$2y$10$dummyhashedpassword', NULL, '0729988776', 'No.22, New Bazaar, Kurunegala', '3', '6', '450', NULL, NULL, NULL, 1, 'Pending', '2025-04-28 12:01:33', '2025-04-28 12:01:33', '0723322114', 'Father', 'active', 1),
(8, 'Nimesha Bandara', 'nimeshaB', 'nimesha@mail.com', '$2y$10$dummyhashedpassword', NULL, '0784433221', 'No.5, Temple Road, Matara', '2', '4', '780', NULL, NULL, NULL, 1, 'Pending', '2025-04-28 12:01:33', '2025-04-28 12:01:33', '0789876543', 'Mother', 'active', 3),
(9, 'Sahan Rajapaksha', 'sahanR', 'sahan@mail.com', '$2y$10$dummyhashedpassword', NULL, '0765544332', 'No.20, Park Avenue, Nugegoda', '1', '5', '356', NULL, NULL, NULL, 1, 'Pending', '2025-04-28 12:01:33', '2025-04-28 12:01:33', '0761234567', 'Father', 'active', 3),
(10, 'Nadeesha Udugama', 'nadeeshaU', 'nadeesha@mail.com', '$2y$10$dummyhashedpassword', NULL, '0708765432', 'No.30, Flower Road, Panadura', '1', '6', '377', NULL, NULL, NULL, 1, 'Pending', '2025-04-28 12:01:33', '2025-04-28 12:01:33', '0702233445', 'Mother', 'active', 3),
(11, 'Ravindu Samarasinghe', 'ravinduS', 'ravindu@mail.com', '$2y$10$dummyhashedpassword', NULL, '0749876543', 'No.42, Sea View, Negombo', '1', '5', '411', NULL, NULL, NULL, 1, 'Pending', '2025-04-28 12:01:33', '2025-04-28 12:01:33', '0741122334', 'Father', 'active', 1),
(12, 'Dilshan Abeysekara', 'dilshanA', 'dilshan@mail.com', '$2y$10$dummyhashedpassword', NULL, '0736677889', 'No.88, Central Road, Ratnapura', '2', '9', '525', NULL, NULL, NULL, 1, 'Pending', '2025-04-28 12:01:33', '2025-04-28 12:01:33', '0739988776', 'Father', 'active', 2),
(13, 'Sachini Madushani', 'sachiniM', 'sachini@mail.com', '$2y$10$dummyhashedpassword', NULL, '0791122334', 'No.18, High Street, Anuradhapura', '3', '7', '612', NULL, NULL, NULL, 1, 'Pending', '2025-04-28 12:01:33', '2025-04-28 12:01:33', '0796655443', 'Mother', NULL, NULL),
(14, 'Kavindu Senanayake', 'kavinduS', 'kavindu@mail.com', '$2y$10$dummyhashedpassword', NULL, '0723344556', 'No.25, River Road, Polonnaruwa', '2', '8', '501', NULL, NULL, NULL, 1, 'Pending', '2025-04-28 12:01:33', '2025-04-28 12:01:33', '0725566778', 'Father', NULL, NULL),
(15, 'Iresha Dissanayake', 'ireshaD', 'iresha@mail.com', '$2y$10$dummyhashedpassword', NULL, '0752233445', 'No.77, Mountain View, Badulla', '3', '9', '645', NULL, NULL, NULL, 1, 'Pending', '2025-04-28 12:01:33', '2025-04-28 12:01:33', '0757788990', 'Mother', NULL, NULL);
...
CREATE TABLE `divisions` (
  ...
  `population_coverage` int(11) NOT NULL,
...
INSERT INTO `divisions` (`division_id`, `division_name`, `location`, `population_coverage`, `contact_information`, `created_at`) VALUES
(1, 'Colombo', 'Western Province', 2325000, 'colombo@divisions.lk | +94 11 123 4567', '2025-04-27 15:30:32'),
(2, 'Gampaha', 'Western Province', 2350000, 'gampaha@divisions.lk | +94 33 223 4567', '2025-04-27 15:30:32'),
(3, 'Kandy', 'Central Province', 1370000, 'kandy@divisions.lk | +94 81 223 4567', '2025-04-27 15:30:32'),
(4, 'Galle', 'Southern Province', 1095000, 'galle@divisions.lk | +94 91 223 4567', '2025-04-27 15:30:32'),
(5, 'Jaffna', 'Northern Province', 583000, 'jaffna@divisions.lk | +94 21 223 4567', '2025-04-27 15:30:32'),
(6, 'Kurunegala', 'North Western Province', 1614000, 'kurunegala@divisions.lk | +94 37 223 4567', '2025-04-27 15:30:32'),
(7, 'Anuradhapura', 'North Central Province', 910000, 'anuradhapura@divisions.lk | +94 25 223 4567', '2025-04-27 15:30:32'),
(8, 'Ratnapura', 'Sabaragamuwa Province', 1124000, 'ratnapura@divisions.lk | +94 45 223 4567', '2025-04-27 15:30:32'),
(9, 'Matara', 'Southern Province', 821000, 'matara@divisions.lk | +94 41 223 4567', '2025-04-27 15:30:32'),
(10, 'Batticaloa', 'Eastern Province', 526000, 'batticaloa@divisions.lk | +94 65 223 4567', '2025-04-27 15:30:32');
...
(18, '2025_04_27_113829_create_divisions_table', 10),
(19, '2025_04_27_121812_add_fields_to_clients_table', 11),
(20, '2025_04_27_122504_create_baby_table', 12),
(21, '2025_04_27_122708_create_vaccine_table', 13),
(22, '2025_04_27_122847_create_vaccination_record_table', 14),
(23, '2025_04_27_123015_create_notice_table', 15),
(24, '2025_04_28_035313_create_weight_record_table', 16),
(25, '2025_04_28_080116_add_bmi_to_baby_table', 17),
(26, '2025_04_28_123132_add_division_id_to_clients_table', 18);
...
CREATE TABLE `notice` (
  ...
  `notice_type` enum('general','urgent','reminder') DEFAULT NULL,
  `target_group` enum('parents','midwives','all') DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `notice` (`notice_id`, `title`, `content`, `sender_type`, `sender_id`, `notice_type`, `target_group`, `created_at`, `scheduled_at`, `expires_at`) VALUES
(1, 'System Maintenance', 'The system will be down for maintenance on May 1st.', 'MOH', 1, 'general', 'all', NULL, '2025-04-29 14:16:00', '2025-05-01 14:34:33'),
(3, 'New Feature Release', 'We are excited to announce a new feature coming soon!', 'admin', 2, '', 'all', '2025-04-28 14:36:12', '2025-05-05 04:30:00', '2025-05-10 18:29:59'),
(4, 'Holiday Notice', 'The office will remain closed on May 15th for a public holiday.', 'hr', 3, '', 'all', '2025-04-28 14:36:12', '2025-05-10 03:30:00', '2025-05-15 18:29:59');
...
CREATE TABLE `sellers` (
  ...
  `professional_credentials` text DEFAULT NULL,
  `division_id` bigint(20) UNSIGNED DEFAULT NULL,
...
INSERT INTO `sellers` (`id`, `name`, `username`, `email`, `password`, `picture`, `phone`, `address`, `provinces`, `districts`, `cities`, `latitude`, `longitude`, `email_verified_at`, `verified`, `created_at`, `updated_at`, `service1`, `service2`, `service3`, `About_Field`, `Certificate`, `status`, `professional_credentials`, `division_id`, `account_status`) VALUES
(1, 'saduni', 'seller', 'seller@mail.com', '$2y$10$KKGpQVNXLzs5WeDYjoY9IuGJRJMills6v/vNg9VquD5IHbWCgyGBa', 'SELLER_IMG_54311745780875680e808bdad26.jpg', '0112345566', '4 Elm Street Springfield, IL 62701 United States', '5', '23', '1678', NULL, NULL, NULL, 1, '2024-07-24 12:02:55', '2025-04-27 13:38:00', 8, 9, 13, 'I have 3 years experience.', 'SELLER_CERTIFICATE_2891172209693066a51d22aab20.jpg', 1, NULL, 1, 'active'),
(2, 'Udith Shirantha', NULL, 'udith@mail.com', '$2y$10$NJuC3DZVHpg15tYvyFwj1.lZqHrZm.A.6RUUwfSBvq9y8OvBQiIYK', 'SELLER_IMG_2902172245959566aaa5cbb9a0f.jpg', '0112548632', 'Winterfall, North', '1', '5', '340', NULL, NULL, NULL, 1, '2024-07-29 23:50:23', '2024-07-31 15:29:55', 7, 9, 12, 'Experienced technician with 5+ years in troubleshooting and repairing', 'SELLER_CERTIFICATE_3322172231759766a87b1dd33d6.jpg', 1, NULL, 2, 'active'),
(3, 'Anurada Kumari', NULL, 'anura@mail.com', '$2y$10$NJuC3DZVHpg15tYvyFwj1.lZqHrZm.A.6RUUwfSBvq9y8OvBQiIYK', 'SELLER_IMG_1633172245965366aaa60564812.jpg', '0112548632', 'Winterfall, North', '1', '5', '340', NULL, NULL, NULL, 1, '2024-07-29 23:50:23', '2024-07-31 15:30:53', 7, 9, 12, 'Experienced technician with 5+ years in troubleshooting and repairing', 'SELLER_CERTIFICATE_3322172231759766a87b1dd33d6.jpg', 1, NULL, 3, 'active'),
(4, 'Mahinda', NULL, 'mahinda@mail.com', '$2y$10$n95k7nuM1GvCs32nK7uutOJ4Ro2VVsdQpc7yl/J6M8USRkks8YH/G', 'SELLER_IMG_5214172245871366aaa259d52bd.jpg', '0112696969', 'Medamulana', '1', '5', '334', NULL, NULL, NULL, 1, '2024-07-31 15:13:54', '2025-04-19 12:33:10', 9, 12, 13, 'I Have 3 year experience about this field.', 'SELLER_CERTIFICATE_3684172245904466aaa3a4a2832.jpg', 1, NULL, 2, 'active'),
(5, 'piyumi', NULL, 'piyumi@mail.com', '$2y$10$MYa3CWKtZl2t/9p66DXe8ebAa5qpLVQ101GMSI236xVcpsenNzJZ6', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2025-04-19 12:37:43', '2025-04-19 12:37:43', NULL, NULL, NULL, NULL, NULL, 0, NULL, 6, 'active'),
(6, 'chana', NULL, 'chana@gmail.com', '$2y$10$7j282GNg2ir3voaTnF9Ble8S0aSchQFE.0xcyM4Ubveno3K6SVcfG', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2025-04-27 03:48:03', '2025-04-27 03:48:03', NULL, NULL, NULL, NULL, NULL, 0, NULL, 2, 'active');
...
CREATE TABLE `vaccine` (
  ...
  `doses_required` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `vaccine` (`vaccine_id`, `vaccine_name`, `description`, `recommended_age_months`, `doses_required`, `created_at`) VALUES
(1, 'RSV ', 'RSV antibody technically isn’t a vaccine, as it provides ready-made protection. This makes it different from a vaccine, which trains your baby’s immune system to create antibodies. So, providers call it an immunization. But most people use the words interchangeably.', 6, 3, '2025-04-27 09:09:08'),
(2, 'HepB', 'Hepatitis B vaccine. Ideally, the first dose is given within 12–24 hours of birth, but kids not previously vaccinated can get it at any age', 6, 2, '2025-04-27 14:16:20'),
(3, 'BCG', 'Tuberculosis', 2, 6, '2025-04-28 07:18:13');
...
CREATE TABLE `weight_record` (
  ...
  `head_circumference` decimal(10,2) DEFAULT NULL,
...
INSERT INTO `weight_record` (`record_id`, `baby_id`, `weight`, `height`, `head_circumference`, `midwife_id`, `record_date`, `notes`, `created_at`, `updated_at`) VALUES
(1, 1, 3.25, 60.00, NULL, 6, '2025-04-28', 'update end rec', '2025-04-27 23:11:32', '2025-04-27 23:11:32'),
(2, 2, 3.80, 63.00, NULL, 6, '2025-04-28', 'no', '2025-04-27 23:15:44', '2025-04-27 23:15:44'),
(3, 2, 3.50, 61.00, 38.50, 7, '2025-04-28', 'First weekly checkup', '2025-04-27 23:30:00', '2025-04-27 23:30:00'),
(4, 3, 4.20, 62.30, 39.00, 6, '2025-05-05', 'Gained weight normally', '2025-05-05 01:00:00', '2025-05-05 01:00:00'),
(5, 4, 3.80, 60.50, 37.80, 8, '2025-05-12', 'Slight fever observed', '2025-05-12 02:50:00', '2025-05-12 02:50:00'),
(6, 5, 4.50, 63.00, 39.20, 7, '2025-05-19', 'Healthy progress', '2025-05-19 03:45:00', '2025-05-19 03:45:00'),
(7, 6, 3.90, 59.80, 38.00, 6, '2025-05-26', 'Under observation', '2025-05-26 05:15:00', '2025-05-26 05:15:00'),
(8, 7, 4.00, 61.20, 38.70, 7, '2025-06-02', 'No issues', '2025-06-02 05:35:00', '2025-06-02 05:35:00'),
(9, 8, 4.30, 62.50, 39.50, 8, '2025-06-09', 'Good appetite', '2025-06-09 06:30:00', '2025-06-09 06:30:00'),
(10, 9, 3.60, 58.70, 37.50, 7, '2025-06-16', 'Recommended extra nutrition', '2025-06-16 07:40:00', '2025-06-16 07:40:00'),
(11, 10, 4.70, 64.00, 40.00, 6, '2025-06-23', 'Excellent growth', '2025-06-23 08:55:00', '2025-06-23 08:55:00'),
(12, 11, 3.70, 59.50, 37.90, 8, '2025-06-30', 'Regular visit', '2025-06-30 10:00:00', '2025-06-30 10:00:00'),
(13, 1, 3.20, 60.00, 38.00, 6, '2025-04-28', 'First weekly checkup', '2025-04-28 02:30:00', '2025-04-28 02:30:00'),
(14, 1, 3.40, 61.00, 38.50, 6, '2025-05-05', 'Steady growth', '2025-05-05 03:00:00', '2025-05-05 03:00:00'),
(15, 1, 3.60, 62.00, 39.00, 6, '2025-05-12', 'Healthy progress', '2025-05-12 03:30:00', '2025-05-12 03:30:00'),
(16, 1, 3.80, 63.00, 39.20, 6, '2025-05-19', 'No health issues', '2025-05-19 04:00:00', '2025-05-19 04:00:00'),
(17, 1, 4.00, 64.00, 39.50, 6, '2025-05-26', 'Excellent development', '2025-05-26 04:30:00', '2025-05-26 04:30:00'),
(18, 1, 3.80, 66.00, NULL, 1, '2025-04-28', NULL, '2025-04-28 02:27:28', '2025-04-28 02:27:28'),
(19, 1, 3.80, 66.00, NULL, 1, '2025-04-28', NULL, '2025-04-28 02:29:12', '2025-04-28 02:29:12'),
(20, 1, 3.80, 66.00, NULL, 1, '2025-04-28', NULL, '2025-04-28 02:29:31', '2025-04-28 02:29:31'),
(21, 1, 3.80, 66.00, NULL, 1, '2025-04-28', NULL, '2025-04-28 02:32:40', '2025-04-28 02:32:40'),
(22, 1, 3.80, 66.00, NULL, 1, '2025-04-28', NULL, '2025-04-28 02:33:10', '2025-04-28 02:33:10'),
(23, 4, 3.70, 68.00, NULL, 1, '2025-04-28', 'need increase weight', '2025-04-28 07:31:11', '2025-04-28 07:31:11'),
(24, 2, 3.10, 59.50, 37.50, 7, '2025-04-28', 'Initial checkup', '2025-04-28 03:30:00', '2025-04-28 03:30:00'),
(25, 2, 3.30, 60.20, 38.00, 7, '2025-05-05', 'Gaining weight', '2025-05-05 03:40:00', '2025-05-05 03:40:00'),
(26, 2, 3.50, 61.00, 38.50, 7, '2025-05-12', 'Healthy growth', '2025-05-12 03:50:00', '2025-05-12 03:50:00'),
(27, 2, 3.70, 62.00, 39.00, 7, '2025-05-19', 'Improved appetite', '2025-05-19 04:00:00', '2025-05-19 04:00:00'),
(28, 2, 3.90, 63.00, 39.20, 7, '2025-05-26', 'Steady development', '2025-05-26 04:10:00', '2025-05-26 04:10:00'),
(29, 2, 4.10, 64.00, 39.50, 7, '2025-06-02', 'Normal progress', '2025-06-02 04:20:00', '2025-06-02 04:20:00'),
(30, 2, 4.30, 65.00, 39.80, 7, '2025-06-09', 'Good health', '2025-06-09 04:30:00', '2025-06-09 04:30:00'),
(31, 2, 4.50, 66.00, 40.00, 7, '2025-06-16', 'Steady increase', '2025-06-16 04:40:00', '2025-06-16 04:40:00'),
(32, 2, 4.70, 67.00, 40.30, 7, '2025-06-23', 'Very healthy', '2025-06-23 04:50:00', '2025-06-23 04:50:00'),
(33, 2, 4.90, 68.00, 40.50, 7, '2025-06-30', 'Maintaining growth', '2025-06-30 05:00:00', '2025-06-30 05:00:00'),
(34, 2, 5.10, 69.00, 40.80, 7, '2025-07-07', 'Excellent weight gain', '2025-07-07 05:10:00', '2025-07-07 05:10:00'),
(35, 2, 5.30, 70.00, 41.00, 7, '2025-07-14', 'Healthy child', '2025-07-14 05:20:00', '2025-07-14 05:20:00'),
(36, 2, 5.50, 71.00, 41.20, 7, '2025-07-21', 'Good activity levels', '2025-07-21 05:30:00', '2025-07-21 05:30:00'),
(37, 2, 5.70, 72.00, 41.50, 7, '2025-07-28', 'Energetic and active', '2025-07-28 05:40:00', '2025-07-28 05:40:00'),
(38, 2, 5.90, 73.00, 41.80, 7, '2025-08-04', 'Very healthy development', '2025-08-04 05:50:00', '2025-08-04 05:50:00');
...
--
-- Indexes for table `weight_record`
--
...
--
ALTER TABLE `baby`
  MODIFY `baby_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `divisions`
  MODIFY `division_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `notice`
  MODIFY `notice_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `vaccine`
  MODIFY `vaccine_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `weight_record`
--
ALTER TABLE `weight_record`
  MODIFY `record_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
